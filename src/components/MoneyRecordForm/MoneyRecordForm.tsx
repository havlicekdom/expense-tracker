...
const schema = yup.object({
  value: yup.number().min(1, 'You must enter positive, non-zero value').required('Please enter the value'),
...
function MoneyRecordForm({
  open, handleClose, submitHandler, actionTitle, moneyRecord,
}: Props) {
